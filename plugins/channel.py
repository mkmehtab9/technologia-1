...
async def send_movie_updates(bot, file_name, caption, file_id):
    try:
        ...
        caption_message = f"<b>`{movie_name}` {language} {quality} - Is Now Available ‼️</b>" 
        search_movie = movie_name.replace(" ", '-')
        btn = [[
            InlineKeyboardButton('♻️ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ ♻️', url=f'https://t.me/movies_group8')
        ]]
        reply_markup = InlineKeyboardMarkup(btn)
        await bot.send_message(MOVIE_UPDATE_CHANNEL, 

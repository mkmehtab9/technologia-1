...
from info import ADMINS, LOG_CHANNEL, USERNAME, WELCOME_VID
            ...
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_video(
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup(
                                                                         [[
                                                                           InlineKeyboardButton("𝗗𝗿𝗮𝗴𝗼𝗻 𝗕𝗼𝘁𝘇", url=f'https://t.me/moviehiap')
                                                                         ]]
                                                 ),
                                                 parse_mode=enums.ParseMode.HTML
                )
        #await bot.send_message(LOG_CHANNEL, script.NEW_AMAN_TXT.format(message.chat.title, message.chat.id, message.chat.username), disable_web_page_preview=True)  
